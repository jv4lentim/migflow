...
class AuditAnalyzerTest < Minitest::Test
  ...
  def test_missing_index_rule_detects_unindexed_fk
    ...
    warnings = Migflow::Analyzers::Rules::MissingIndexRule.new.call(tables)
  ...
  def test_string_without_limit_rule_detects_unlimited_string
    ...
    warnings = Migflow::Analyzers::Rules::StringWithoutLimitRule.new.call(tables)
    assert_equal 1, warnings.size
  ...
  def test_missing_timestamps_rule_detects_missing_timestamps
    ...
    warnings = Migflow::Analyzers::Rules::MissingTimestampsRule.new.call(tables)
    assert_equal 1, warnings.size
  ...
  def test_dangerous_migration_rule_detects_remove_column
    ...
    warnings   = Migflow::Analyzers::Rules::DangerousMigrationRule.new.call_with_migrations(migrations)
  ...
  def test_missing_foreign_key_rule_detects_fk_column
    ...
    warnings = Migflow::Analyzers::Rules::MissingForeignKeyRule.new.call(tables)
    assert_equal 1, warnings.size
    assert_equal :info, warnings.first.severity
  end
end
